...
Let's take a look at our failed function again.
...
To fix `grouped_mean()`, all we need to do is _embrace_ `var_group` and `var_summary` with the operator `{{ }}` (pronounced "curly curly").
